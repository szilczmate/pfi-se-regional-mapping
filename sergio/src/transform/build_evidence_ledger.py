...
LEDGER = [
    ...
    ("CH-12", "Strategic", "ANALYTICAL_FINDINGS_v1.docx", "Ch 12 — Priority matrix",
     ...
     "Modeled → upgrade with audit-recommended Actionability axis (work item #3 in roadmap)."),
    ...
    ("DT-06", "QA", "Robustness QA sheet", "27/27 robustness checks pass",
     "All 27 robustness checks pass with 0 critical issues, 0 warnings (fact-check audit confirmation).",
     "Observed",
