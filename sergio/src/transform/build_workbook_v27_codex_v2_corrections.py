...
"""Build master_workbook_v27.xlsx — Codex audit v2 corrections.
...
def fix_build_pipeline(wb):
    ...
    ws.append(['Workbook v26 → v27 (THIS BUILD)', '06_master_workbook_v27.xlsx', 'build_workbook_v27_codex_v2_corrections.py',
               'Codex audit v2 corrections: version-control cleanup; Evidence Ledger EX-04/06 stale-Kisqali language fix; '
...
def add_verzenios_trajectory_sheet(wb):
    ...
    ws.append(['Why this matters', 'Codex audit v2 P1 finding: 1H vs 2H comparison overstates trend if Verzenios was '
